...
{{< imagepair
  leftSrc="finished-nesting-bass-drum-closed.jpg"
  leftAlt="The finished bass drum closed"
  rightSrc="finished-nesting-bass-drum-open.jpg"
  rightAlt="The finished bass drum open"
>}}
...
![The original blue donor bass drum before refurbishment](original-blue-donor-bass-drum.webp)
...
![A homemade router jig for cutting the shell evenly](homemade-router-cutting-jig.jpg)
...
![Routing the shell to split it into two sections](cutting-the-shell-with-router.gif)
...
![High point sanding](sanding-high-points-on-shell-edge.gif)
...
![Further sanding](flattening-shell-edge-with-sandpaper.gif)
...
![Cutting the lip](cutting-interlocking-lip-with-router.gif)

Overall, I am quite happy with how the interlocking rims turned out.

![The lip cuts](interlocking-shell-lips.webp)
...
![A latch fitted to help secure the nesting shell](latch-fitted-to-shell.jpg)
...
![Applying the new black wrap to the rebuilt shell](applying-black-wrap-to-shell.jpg)
...
![The completed refurbished nesting bass drum](completed-nesting-bass-drum.webp)
...
![The nesting drum kit set up for its first gig](nesting-drum-first-gig.png)
